...
public class UnprintableMultiplication extends BinaryOp  implements FloatCalculable{
	
	public UnprintableMultiplication(MathsOp op1, MathsOp op2) {
		super(op1, op2);
	}	
	...
	public String toString() {
		...
		if(op[0] instanceof Addition || op[0] instanceof Subtraction)
			return LEFT_BRACKET + op[0].toString() + RIGHT_BRACKET + "" + res; 
		else
