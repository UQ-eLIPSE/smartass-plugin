...
/**
 * Describe class WhileModArrayEvalModule here.
 *
 *
 ...
 * @version 1.0
 */
public class WhileModArrayEvalModule extends AbstractPythonEvalModule {

    private static final int MIN_LEN = 7;
    private static final int MAX_LEN = 12;

    /**
     * Creates a new <code>WhileModArrayEvalModule</code> instance.
     *
     */
    public WhileModArrayEvalModule() {
        super();
    ...
    private void generate() {
        ...
        do {
            ...
            ifs = RandomPythonGen.randModIf(i);
